...
unsigned int nStakeMinAge = 60 * 60 * 24 * 5;	// minimum age for coin age: 3d
...
int64 nChainStartTime = 1404421199; // Banksycoin IS
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, uint256 prevHash)
{
	...
	if(nHeight <= 200)
	{
		nSubsidy = 150000 * COIN;	// 15000 coins per block.
	...
	*/
	  ...
	  int64 nSubsidy = 17 * COIN;
	  
        if(nHeight <  2)    
        {
                nSubsidy = .1 * COIN;		
        }
		else if(nHeight >= 3 && nHeight < 14) 
        {
...
unsigned int GetNextTargetRequired(const CBlockIndex* pindexLast, bool fProofOfStake) 
{
   ...
   if (pindexLast->nHeight > 300000 ) {     //SET TIME SPAN TO 120 Seconds.
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "BanksyCoin is Born!";
        CTransaction txNew;
 ...
 if (false && (block.GetHash() != hashGenesisBlock))
        ...
        printf("block.nNonce = %u \n", block.nNonce);
			block.print(); 
	// 9e31067616ad2d62a86553f6ddc1e9b040029385547b90f7becb2161aa623baf
	// 9e31067616ad2d62a86553f6ddc1e9b040029385547b90f7becb2161aa623baf
	assert(block.hashMerkleRoot == uint256("0xac17958aa0b539c8b9b0cd18afc9110af94cf21489e0c4632b7f603da0de530c"));
...
CBlock* CreateNewBlock(CWallet* pwallet, bool fProofOfStake)
{
	...
	//txNew.vout[0].scriptPubKey << 0x0 << OP_CHECKSIG;
