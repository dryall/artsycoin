...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Banksycoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
	...
	{"66.85.133.206", "66.85.133.206"},
	{"82.221.100.157", "82.221.100.157"},
	{"66.85.133.207", "66.85.133.207"},
	{NULL,NULL},
};
...
void ThreadDNSAddressSeed(void* parg)
{
    ...
    RenameThread("Banksycoin-dnsseed");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Banksycoin is probably already running."), addrBind.ToString().c_str());
        else
