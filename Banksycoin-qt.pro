...
OTHER_FILES += \
    doc/*.rst doc/*.txt doc/README README.md res/bitcoin-qt.rc src/test/*.cpp src/test/*.h src/qt/test/*.cpp src/qt/test/*.h doc/*.md \

# platform specific defaults, if not overridden on command line
isEmpty(BOOST_LIB_SUFFIX) {
    macx:BOOST_LIB_SUFFIX = -mt
    windows:BOOST_LIB_SUFFIX =-mgw48-mt-s-1_54#-mgw44-mt-s-1_50
}
...
macx:ICON = src/qt/res/icons/Banksycoin.icns
macx:TARGET = "Banksycoin-Qt"
